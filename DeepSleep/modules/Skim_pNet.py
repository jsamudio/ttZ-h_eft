...
class Skim:
    ...
    2. apply event level cuts/filters to eliminate unwanted events
    ...
    def startSkim(self):
        ...
        self.fatjets     = self.build_dict(['FatJet_pt','FatJet_particleNet_mass'])
        ...
        self.jets        = self.build_dict(cfg.ana_vars['ak4vars']+cfg.ana_vars['ak4lvec']['TLVars'], with_interp=False)
